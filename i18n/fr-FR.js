let frFR = {
  ...
  "dangerDanger"   :"Ceci est testé modérément. Ainsi aucun bug n'a été découvert, je ne suis responsable d'aucun problème!",
  ...
  "warningBrowser" :"Ceci ne marche sur aucun autre navigateur que chrome, Car ils n'intêgrent pas WebUSB.",
  "warningLinux"   :"sur linux vous pouvez avoir, 'Accès interdit' ou 'Pas d'appareil compatible' erreur dans le dialogue de connection! Si vous le faites , vous pouvez essayer de créer un fichier à  <code>/etc/udev/rules.d/50-switch.rules</code>Avec le contenu suivant:<br><code>SUBSYSTEM==\"usb\", ATTR{idVendor}==\"0955\", MODE=\"0664\", GROUP=\"plugdev\"</code>",
  "warningTested"  :"Ceci à été testé et fonctionne sur Linux, OSX, Android (non-root) et Chromebooks. Cela peut varier.",
  "labelInstructions" :"Instructions:",
  "liRCM"          :"Mettez la Switch en RCM, et connectez là à votre appareil.",
  ...
  "h4SelectPayload" :"Selectionner le Payload:",
